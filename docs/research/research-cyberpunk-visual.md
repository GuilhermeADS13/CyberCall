# Pesquisa visual — referência Cyberpunk

A referência analisada foi https://www.cyberpunk.net/br/pt-br/ em 20 de agosto de 2026. O objetivo é reutilizar princípios visuais, não copiar imagens, logotipos, textos ou URLs de assets proprietários.
...
- Página oficial: https://www.cyberpunk.net/br/pt-br/
- Inspiração de UI pública: https://www.wendyzhou.se/blog/cyberpunk-ui-website-design-inspiration/
- Referência de tendências de UI: https://hype4.academy/articles/design/ui-trends-for-2077

## Restrições de implementação

Não reutilizar diretamente imagens, logotipos, ícones ou URLs do CDN oficial no produto Cyperpuck. Os próximos assets devem ser gerados ou desenhados para a Cyperpuck, com composição cinematográfica, contraste âmbar/ciano e linguagem editorial futurista, sem reproduzir personagens, marcas ou cenas identificáveis da franquia.
